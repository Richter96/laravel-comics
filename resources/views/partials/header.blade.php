<header id="app_header">
    <div class="container-md d-flex align-items-center justify-content-between">
        ...
        <nav class="nav justify-content-center">
            ...
            <a class="nav-link {{Route::currentRouteName()=== '#' ? 'active' : ''}}" href="#" aria-current="page">COLLECTIBLES</a>
            <a class="nav-link {{Route::currentRouteName()=== '#' ? 'active' : ''}}" href="#" aria-current="page">VIDEOS</a>
            <a class="nav-link {{Route::currentRouteName()=== '#' ? 'active' : ''}}" href="#" aria-current="page">FANS</a>
            <a class="nav-link {{Route::currentRouteName()=== '#' ? 'active' : ''}}" href="#" aria-current="page">NEWS</a>
            <a class="nav-link {{Route::currentRouteName()=== '#' ? 'active' : ''}}" href="#" aria-current="page">SHOP</a>
        </nav>
    </div>
</header>
